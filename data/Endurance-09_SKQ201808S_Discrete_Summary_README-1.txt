Endurance 09 (R/V Sikuliaq, 2018-03-25 to 2018-04-05) Discrete Sampling README

Revision History:

1.00 (2019-02-19) -- Assembled and published to Alfresco 2019-02-19. Still missing Discrete Salinity estimates.
1.01 (2019-02-21) -- Cleaned up flags used for DIC samples and updated this README with notes for discrete samples.
...
SKQ201803S, Cast 7, Bottle 7, Discrete Oxygen Flag -- Analysis reports did not include results for the duplicate sample. It can only be assumed that the sample is missing or otherwise lost/damaged. We are reporting the value with a fill value.

SKQ201803S, All Casts, All Bottles, Discrete Fluorescence Flag -- All chlorophyll estimates derived using the Welschmeyer non-acidification technique (https://doi.org/10.4319/lo.1994.39.8.1985). No estimates of the Discrete Phaeopigment or Discrete Fo/Fa will be provided.

SKQ201803S, All Casts, All Bottles, Discrete Nutrients Flag -- All samples processed by Dr. Burke Hale's laboratory group at Oregon State University with the following reported nominal lower concentration detection limits for each nutrient:
...
SKQ201803S, All Casts, All Bottles, Discrete Salinity Flag -- Waiting for analysis results. Will update spreadsheet once we have the updated values.

SKQ201803S, All Casts, All Bottles, Discrete Alkalinity Flag -- This value is not measured directly by the analysis lab that processes our samples. Instead, see the calculated Alkalinity value, which is reported at in-situ temperatures.

SKQ201803S, All Casts, All Bottles, Discrete DIC Flag -- All values are reported at in-situ temperatures.

SKQ201803S, All Casts, All Bottles, Discrete pCO2 Flag -- All values are reported at in-situ temperatures.

SKQ201803S, All Casts, All Bottles, Discrete pH Flag -- This value is not measured directly by the analysis lab that processes our samples. All Calculated pH values are reported in total scale referenced to in-situ temperature.
